...
class TestOptions():
    ...
    def initialize(self):
        ...
        # # evaluator
        # self.parser.add_argument("--evaluator_dir", type=str, default='/data/yiheng_huang/data/pretrained_models',
        #                          help='Directory path where save T2M evaluator\'s checkpoints')
        # self.parser.add_argument("--eval_meta_dir", type=str, default='/data/yiheng_huang/data',
        #                          help='Directory path where save T2M evaluator\'s normalization data.')
        # self.parser.add_argument("--glove_dir", type=str, default='/data/yiheng_huang/data/glove',
        #                          help='Directory path where save glove')
        self.parser.add_argument("--evaluator_dir", type=str, default='TM2T/checkpoints/', help='Directory path where save T2M evaluator\'s checkpoints')
        ...
        # inference
        self.parser.add_argument("--num_inference_steps", type=int, default=10,
                                 help='Number of iterative denoising steps during inference.')
        self.parser.add_argument("--which_ckpt", type=str, default='latest', help='name of checkpoint to load')
        self.parser.add_argument("--diffuser_name", type=str, default='dpmsolver',
                                 help='sampler\'s scheduler class name in the diffuser library')
        ...
        # evaluation
        self.parser.add_argument("--replication_times", type=int, default=1,
                                 help='Number of generation rounds for each text description')
        ...
        self.parser.add_argument('--mm_num_samples', type=int, default=100,
                                 help='Number of samples for evaluating multimodality')
        self.parser.add_argument('--mm_num_repeats', type=int, default=30,
                                 help='Number of generation rounds for each text description when evaluating multimodality')
