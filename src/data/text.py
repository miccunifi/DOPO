...
from src.text_encoder.text_encoder import TextToEmb
...
class ClipEmbeddings:
    ...
    def __init__(
        ...
        self.modelname = modelname
        print("  - Check if CLIP embeddings are correct")
        self.embeddings_folder = os.path.join(
            "/deck/datasets/Black_datasets(H_K_B)/annotations", dataname, "text_embeddings"
        )
        self.cache = {}
        self.device = device
        self.disable = disable
