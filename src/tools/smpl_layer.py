...
class SMPLH(nn.Module):
    ...
    def to(self, device): # mycode
        self.smplh.left_hand_mean.to(device)
        self.smplh.right_hand_mean.to(device)
        # self.v_template.to(device)
        # self.shapedirs.to(device)
        # self.posedirs.to(device)
        # self.J_regressor.to(device)
        # self.parents.to(device)
        # self.lbs_weights.to(device)
    ...
    def forward(
        ...
        parameters = {
            ...
            "body_pose": body_pose,
            "left_hand_pose": left_hand_pose, # mycode
            "right_hand_pose": right_hand_pose, # mycode
            "transl": trans_all,
            "betas": betas,
        }
