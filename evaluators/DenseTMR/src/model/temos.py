...
from evaluators.DenseTMR.src.model.losses import KLLoss
from evaluators.DenseTMR.retrieval import extract
...
class TEMOS(LightningModule):
    ...
    def call_models(self, batch):
        ...
        motion_x_dict["t"] = batch["motion_x_dict"]["t"]
    ...
    def training_step(self, batch: Dict, batch_idx: int) -> Tensor:
        bs = len(batch["motion_x_dict"]["x"]) # sembra già normalizzato
